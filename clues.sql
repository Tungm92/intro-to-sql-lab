...
-- attending language classes in this country's officially recognized language. 
...
-- to catch her this time. There are only two cities she could be flying to 
-- in the country. One is named the same as the country – that would be too obvious. 
...
-- capital, and get there pronto! Send us the name of where you're headed 
...
-- We have one chance to catch her, we just have to know where she's heading 
-- and beat her to the landing dock. Lucky for us, she's getting cocky. 
-- She left us a note (below), and I'm sure she thinks she's very clever, 
